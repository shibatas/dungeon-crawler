...
const Footer = () => {
	return (
		<footer style={{textAlign:'center'}}>
			<hr style={{width: '90%'}}/>
		        <p>This is a <a href="https://www.freecodecamp.org/challenges/build-a-roguelike-dungeon-crawler-game" target="_blank" rel="noopener noreferrer">freeCodeCamp project</a>. The code can be found <a href="https://github.com/shibatas/dungeon-crawler" target="_blank" rel="noopener noreferrer">here</a>.</p>
